...
class UserLogin(BaseModel):
    """Request model for JSON-based user login.
...
class SessionResponse(BaseResponse):
    ...
    created_at: datetime | None = Field(default=None, description="When the session was created")

    @field_serializer("created_at")
    def serialize_created_at(self, dt: datetime | None) -> str | None:
        """Serialize created_at ensuring UTC ISO format."""
        if dt is None:
            return None
